...
function App() {
  ...
  const helloList = <> {data.map((poke,index) =>  <article key={index} style={{
    backgroundColor: getColorHexa(poke.apiTypes[0].name), borderColor: getColorHexa(poke.apiTypes[0].name) }}>
      <figure>
        <picture>
